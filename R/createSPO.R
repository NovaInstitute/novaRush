...
#' 1 prov:startedAtTime :Survey       xsd:dateTime  starttime
#' 2 prov:endedAtTime   :Survey       xsd:dateTime  endtime
#' 3 rdf:type           owl:Thing     :Interview    Interview_ID
#' 
#' long_data
#' A tibble: 3 × 6
#'  subject varname       object                                    predicate        rdfs:domain   rdfs:range
#'  <chr>   <chr>         <chr>                                     <chr>            <chr>         <chr>       
#' 1 1      starttime     2024-02-27 14:18:19                       prov:startedAtT… :Survey       xsd:dateTime
#' 2 1      endtime       2024-02-27 14:41:43                       prov:endedAtTime :Survey       xsd:dateTime
#' 3 1      Interview_ID  uuid:fe690b51-ee58-4294-b7b6-9f941b47b741 owl:Thing        :Interview    Interview_ID  
#' 
